# -*- coding: utf-8 -*-
"""Py_Assignment_2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1wcDBxi3Z5vzD6hSxtMmlueyUN9MFdxB4
...
list_1 = lots_of_spaces.rsplit()
print(list_1)


lots_of_comma = 'hello,how,are,you?'

list_2 = lots_of_comma.rsplit(",")
print(list_2)
...
# 2 ^ 5 # ^ is used for bitwise XOR operator 

2**5 # we can use ** or math pow function to find the power of 2 numbers
...
print("ENTER THE CHOICE 1] addition  2] substraction 3] multiplication 4] division 5] modulus 6]power 7] square root ")
choice = int(input())
...
if choice == 1 :
  ...
  check_for_num = string.isalnum()
  print(check_for_num)
elif choice == 5:
  swapcase = string.swapcase()('a','b')   
  print(swapcase)
...
worked_hours = float(input("Enter the hours worked: "))

if (worked_hours >50):

  total_worked_hours_After_50h = worked_hours - 50

  pay_after_50h_work = total_worked_hours_After_50h * 2.5 * 100

  print("THE PAYOUT FOR AFTER 50H WORK IS :",pay_after_50h_work)

for i in range(1,51):
  payout = 0
  payout = payout + (i * payed_per_hour)
print("THE PAYOUT TILL 50H IS :",payout)

total_payout = payout + pay_after_50h_work

print("THE TOTAL PAY WILL BE : ", total_payout)
...
signal_power = 9
noise_power = 10
ratio = signal_power / noise_power   # remove // so that it wont convert to nearest number
print(ratio)
...
list = [1, 2, 3, 4, 5 ]
member = input("ENTER THE MEMBER U WANT TO FIND: ")
if member in list :
    print("THE MEMBER EXISTS")
  # fill the blanks 
else: 
  print("THE MEMBER DOESNT EXIST")
  # fill the blanks
...
for i in count(0):
  print("ENTER THE CHOICE 1] CELSIUS  2] FAHRENHEIT 3]EXIT #(any value from 3 to infinity will break)")
  choice = (int or string)(input()) 
...
import math
celcius = [ i for i in range(0,104,3) ]

#farhen = [i for i in range(0,104,3)  ]
farhen = []
for i in range(0,104,3 ):
  farhen.append((i*1.8+ 32))


_new_farhen = [ '%.1f' % elem for elem in farhen ]

print("Fahrenheit = ",_new_farhen)
